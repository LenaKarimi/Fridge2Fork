...
public class MealApiModel {
    ...
    public void buildIngredientLists(){
        ingredientList = new ArrayList<>();
        measureList = new ArrayList<>();
        String[] addIngredientList = {strIngredient1, strIngredient2, strIngredient3, strIngredient4,
        ...
        for (String ingredient : addIngredientList){
            if (ingredient != null && !ingredient.isEmpty()){
                ingredientList.add(ingredient);
            }
        }

        String[] addMesureList = {strMeasure1, strMeasure2, strMeasure3, strMeasure4,
        ...
        for (String measure : addMesureList){
